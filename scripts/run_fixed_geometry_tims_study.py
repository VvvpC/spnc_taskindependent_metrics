...
CONFIG_RELATIVE_PATH = Path("configs/tims_frontier/fixed_geometry_beta20.yaml")
...
def main() -> int:
    ...
    summary = run_fixed_parameter_study(
        study_config,
    ...
    payload = {
        ...
        "trial_results_table": summary["artifacts"]["trial_results_table"],
        "frontier_points_table": summary["artifacts"]["frontier_points_table"],
        "failure_log": summary["artifacts"]["failure_log"],

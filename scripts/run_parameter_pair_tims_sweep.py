...
CONFIG_RELATIVE_PATH = Path("configs/tims_frontier/uniform_vs_heterogeneous_parameter_pair_tims_sweep_v1.yaml")
...
from tims_frontier.orchestration import run_parameter_pair_sweep_study
...
def main() -> int:
    ...
    summary = run_parameter_pair_sweep_study(
        study_config,
    ...
    payload = {
        ...
        "parameter_pair_artifacts": summary["parameter_pair_artifacts"],
        "pair_sweep_manifest_path": summary["pair_sweep_manifest_path"],
        "parameter_pair_sweep_summary_path": summary["parameter_pair_sweep_summary_path"],
    }

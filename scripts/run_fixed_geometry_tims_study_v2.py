...
CONFIG_RELATIVE_PATH = Path("configs/tims_frontier/fixed_geometry_beta20_v2.yaml")
...
from tims_frontier.orchestration import run_fixed_geometry_seed_sweep
...
def main() -> int:
    ...
    summary = run_fixed_geometry_seed_sweep(
        study_config,
    ...
    payload = {
        ...
        "morphology_seeds": summary["morphology_seeds"],
        "n_trials_per_family": summary["n_trials_per_family"],

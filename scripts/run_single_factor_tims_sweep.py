...
CONFIG_RELATIVE_PATH = Path("configs/tims_frontier/uniform_vs_heterogeneous_single_factor_tims_sweep_v1.yaml")
...
from tims_frontier.orchestration import run_single_factor_sweep_study
...
def main() -> int:
    ...
    summary = run_single_factor_sweep_study(
        study_config,
    ...
    payload = {
        ...
        "parameter_sweep_artifacts": summary["parameter_sweep_artifacts"],
        "sweep_manifest_path": summary["sweep_manifest_path"],
        "single_factor_sweep_summary_path": summary["single_factor_sweep_summary_path"],
    }

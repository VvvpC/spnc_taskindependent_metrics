...
CONFIG_RELATIVE_PATH = Path("configs/tims_frontier/uniform_vs_heterogeneous_local_boundary_validation_v1.yaml")
...
from tims_frontier.orchestration import run_local_boundary_validation_study
...
def main() -> int:
    ...
    summary = run_local_boundary_validation_study(
        study_config,
    ...
    payload = {
        ...
        "window_order": summary["window_order"],
